...
class ClearingControllerTest {
    ...
    private final static ClearingDataAccess dataAccess= new ClearingDataAccess();
    private final static ClearingInteractor inputBoundary = new ClearingInteractor(outputBoundary, dataAccess);
    private final static ClearingController controller = new ClearingController(inputBoundary);


    @Test
    void testClearing() {
        ClearingOutputData outputData = controller.clearing();
